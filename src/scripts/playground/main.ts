...
const catalog: CatalogEntry[] = [
  ...
  {
    id: "electromagnetism-straight-wire",
    shortName: "Straight-wire B field",
    number: "EM 19",
    category: "Electromagnetism / 电磁学",
    loader: () => import("./games/electromagnetism-straight-wire"),
    help: "Reverse signed current · inspect right-hand direction · R reset",
    formula: "B = μ₀I/(2πr)",
    explanation: "Computed circular field lines reverse with signed current and expose the ideal-wire singularity without clipping it.",
  },
  {
    id: "electromagnetism-current-loop",
    shortName: "Circular current loop",
    number: "EM 20",
    category: "Electromagnetism / 电磁学",
    loader: () => import("./games/electromagnetism-current-loop"),
    help: "Change current, turns, radius, and axial probe · R reset",
    formula: "Bz = μ₀NIa²/[2(a²+z²)³ᐟ²]",
    explanation: "A segmented-loop field drives shared arrows and streamlines while the axis solution is compared with its dipole far field.",
  },
  {
    id: "electromagnetism-solenoid",
    shortName: "Solenoid & fringe",
    number: "EM 21",
    category: "Electromagnetism / 电磁学",
    loader: () => import("./games/electromagnetism-solenoid"),
    help: "Change N, I, radius, length, and axial probe · R reset",
    formula: "Bz = (μ₀nI/2)(cosθ₁−cosθ₂)",
    explanation: "The finite-solenoid axis field quantifies uniform-interior and fringe limits; dashed exterior closure is explicitly qualitative.",
  },
  {
    id: "electromagnetism-biot-savart",
    shortName: "Biot–Savart sketch",
    number: "EM 22",
    category: "Electromagnetism / 电磁学",
    loader: () => import("./games/electromagnetism-biot-savart"),
    help: "Tap canvas to draw wire vertices · undo/refine · reverse I · R reset",
    formula: "dB = (μ₀/4π) I dl×r̂/r²",
    explanation: "A user-drawn segmented conductor exposes every signed current-element contribution and the vector sum at the probe.",
  },
  {
    id: "electromagnetism-ampere",
    shortName: "Ampère loop law",
    number: "EM 23",
    category: "Electromagnetism / 电磁学",
    loader: () => import("./games/electromagnetism-ampere"),
    help: "Compare centered, offset, rectangle, and multi-wire loops · R reset",
    formula: "∮ B·dl = μ₀I enclosed",
    explanation: "Local B·dl samples, enclosed current, residual, and a separate symmetry predicate prevent misuse of Ampère law.",
  },
  {
    id: "electromagnetism-magnetic-dipole",
    shortName: "Magnetic dipole",
    number: "EM 24",
    category: "Electromagnetism / 电磁学",
    loader: () => import("./games/electromagnetism-magnetic-dipole"),
    help: "Rotate or reverse μ · change B and gradient · R reset",
    formula: "τ = μ×B    U = −μ·B    F = ∇(μ·B)",
    explanation: "Torque, potential energy, nonuniform-field force, magnetic moment direction, and closed magnetic flux share one vector model.",
  },
  {
    id: "electromagnetism-wire-force",
    shortName: "Wire force & motor",
    number: "EM 25",
    category: "Electromagnetism / 电磁学",
    loader: () => import("./games/electromagnetism-wire-force"),
    help: "Choose parallel wires, coil, or motor · reverse current · Space pause · . step · R reset",
    formula: "F = I L×B    μ = NIA n̂",
    explanation: "Parallel-wire attraction/repulsion, rectangular-coil torque, and damped motor rotation derive direction from signed cross products.",
  },
  {
