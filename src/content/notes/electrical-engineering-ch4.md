---
title: "正弦交流电路"
documentTitle: "电工学 第4章 正弦交流电路 — NOTEBOOK"
description: "相量、RLC 串并联、交流功率、谐振频率与带宽。"
date: "2026-03-26"
subject: "电工学"
tags: ["电工学","交流电路"]
readingTime: 10
language: "zh-CN"
legacyPath: "/posts/electrical-engineering-ch4.html"
---
    ...
    <div class="post-page">
      ...
      <header class="post-header">
        <div class="post-meta">
          ...
          <span class="post-tag" style="border-color:rgba(220,220,170,0.3);color:#dcdcaa;background:rgba(220,220,170,0.05)">交流电路</span>
        </div>
        <h1>电工学 第4章 · 正弦交流电路</h1>
        <p style="font-size:0.83rem;color:#555;font-family:var(--mono);">// 正弦三要素 · 相量法 · RLC · 功率三角形 · 谐振 · 功率因数</p>
      </header>
...
Step 1  X_L = ωL，X_C = 1/(ωC)
Step 2  Z = R + j(X_L−X_C)；求 |Z| 和 φ = arctan(X/R)
Step 3  I = U/|Z|；ψ_i = ψ_u − φ
Step 4  U_R = IR，U_L = IX_L，U_C = IX_C；画相量图
Step 5  P = UIcosφ，Q = UIsinφ，S = UI；验证 S²=P²+Q²</pre>
