---
title: "电路的暂态分析"
documentTitle: "电工学 第3章 电路暂态分析 — NOTEBOOK"
description: "换路定理、一阶电路的零输入与零状态响应、三要素法。"
date: "2026-03-26"
subject: "电工学"
tags: ["电工学","暂态分析"]
readingTime: 9
language: "zh-CN"
legacyPath: "/posts/electrical-engineering-ch3.html"
---
    ...
    <div class="post-page">
      ...
      <header class="post-header">
        <div class="post-meta">
          ...
          <span class="post-tag" style="border-color:rgba(220,220,170,0.3);color:#dcdcaa;background:rgba(220,220,170,0.05)">暂态分析</span>
        </div>
        <h1>电工学 第3章 · 电路的暂态分析</h1>
        <p style="font-size:0.83rem;color:#555;font-family:var(--mono);">// 储能元件 · 换路定则 · 三要素法 · RC/RL电路 · 微分积分电路</p>
      </header>
...
Step 3  画 t = 0⁺ 等效电路
        ...
        电感 → 恒流源 i_L(0⁺)
         ↓
Step 4  由 t = 0⁺ 电路，用直流电路方法求其余初始值</pre>
